...
const Pagination = ({ totalPages, setCurrentPage, currentEmployees, sortedEmployees }) => {
            ...
            <ul className="pagination">
...

                {
                    numOfPages.map((page, index) => {
                        return (
                            <li onClick={() => setCurrentButton(page)} key={index} className={`${currentButton === page ? 'page-item active' : 'page-item'}`}><a href="#!" className="page-link">{page}</a></li>
                        )
